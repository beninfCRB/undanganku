...
<head>
	...
	<title>Invitation From Beni & Latifah</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">

	<link rel="icon" href="images/half-circle-flower-500.png">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box fadeInUp animated-fast">
						<img src="images/half-circle-flower-500.png" alt="" class="couple-main">
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
						...
						<p><span style="font-size: 36px;color:#f2f2f2; font-family:'Courier New', Courier, monospace"><?= $_GET['to'] ?></span></p>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<br>
					<p>
						<a href="https://calendar.google.com/event?action=TEMPLATE&tmeid=Njdxa29uN20wYm9qazdjdW50OXFqZ21oMHEgYmZhdXppMDlAbQ&tmsrc=bfauzi09%40gmail.com" target="_blank" class="btn btn-primary btn-sm">Save the date</a><br>
		...
		<div class="container">
			...
			<div class="couple-wrap animate-box">
				<div class="couple-half">
					<div class="groom">
						<img src="images/si-P.jpg" alt="groom" class="img-responsive">
					</div>
					<div class="desc-groom">
						<h3>Latifah, S.Kom</h3>
						<p><span style="color: #bf9b73">Putri Kedua dari</span><br>
							<span class="parents-font">Bapak H. Nanang Mislan</span>
							<br>
							<span class="parents-font">Ibu Hj. Musliyah (Almh)</span>
						</p>
						<div id="social-media-rehan">
							<ul class="fh5co-social-icons">
								<li><a target="_blank" href="https://www.facebook.com/rahmatul.latif"><i class="icon-facebook-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.instagram.com/lathifahid/"><i class="icon-instagram-with-circle"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="couple-half">
					<div class="bride">
						<img src="images/si-L.jpg" alt="groom" class="img-responsive">
					</div>
					<div class="desc-bride">
						<h3>Beni Nurfauzi</h3>
						<p><span style="color: #bf9b73">Putra Ketiga dari</span><br>
							<span class="parents-font">Bapak H. Sukardi (Alm)</span>
							<br>
							<span class="parents-font">Ibu Hj. Nurtiyah</span>
						</p>
						<div id="social-media-molid">
							<ul class="fh5co-social-icons">
								<li><a target="_blank" href="https://www.linkedin.com/in/beni-nurfauzi/"><i class="icon-linkedin-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.instagram.com/beni_nf/"><i class="icon-instagram-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.facebook.com/beni.snepack"><i class="icon-facebook-with-circle"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-6 col-sm-6 text-center">
						<div class="event-wrap animate-box">
							...
							<p style="font-family: 'Courgette', Arial, serif">Alamat: Jl. Raya Cirebon - Bandung No.40, Sutawangi, Kec. Jatiwangi, Kabupaten Majalengka, Jawa Barat 45454</p>

							<a href="https://goo.gl/maps/qvfqtxbJoqS9dhn29" target="_blank"
					...
					<div class="col-md-6 col-sm-6 text-center">
						<div class="event-wrap animate-box">
							...
							<div class="event-col">
								<i class="icon-calendar"></i>
								<span>Sabtu</span>
								<span class="tanggal">20 Juli 2022</span>
							</div>
							<p style="font-family: 'Courgette', Arial, serif">Alamat: Komplek pakauman RT.04 RW.07 no.15 dusun 3 Desa Sutawangi Kec. Jatiwangi Kab. Majalengka 45454</p>

							<a href="https://goo.gl/maps/aAiiWvwQPm8DP1ZH9" target="_blank"
							   class="btn btn-primary">Penunjuk Lokasi <i class="icon-map2"></i></a>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<p>Doa restu anda merupakan karunia yang sangat berarti bagi kami dan jika memberi adalah ungkapan tanda terima kasih anda, anda dapat memberi kado secara cashless</p>
				</div>
			</div>
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-6 col-sm-6 text-center">
						<div class="animate-box">
							<img src="./images/bca.png" alt="" width="100px" height="100%">
							<p>No. Rekening</p> 
							 <strong id="text-copy1">4180732948</strong><br>	
							<p>a/n Latifah</p><br>
							<button class="btn btn-copy1">Salin Nomor <i class="icon-copy"></i></button>
						</div>
					</div>
					<div class="col-md-6 col-sm-6 text-center">
						<div class="animate-box">
							<img src="./images/bni.png" alt="" width="100px" height="100%">
							<p>No. Rekening</p> 
							 <strong id="text-copy2">1368762930</strong><br>	
							<p>a/n Beni Nurfauzi</p><br>
							<button class="btn btn-copy2">Salin Nomor <i class="icon-copy"></i></button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row copyright animate-box">
				<div class="col-md-12 text-center">
					...
					<img src="images/half-circle-flower-500.png" width="100" height="100">
					<br>
					<h1 style="font-family: 'Satisfy', Arial, serif">Beni & Thiffa</h1>
					<p>
					<ul class="fh5co-social-icons">
						<li><a target="_blank" href="https://www.linkedin.com/in/beni-nurfauzi/"><i class="icon-linkedin-with-circle"></i></a></li>
						<li><a target="_blank" href="https://www.instagram.com/beni_nf/"><i class="icon-instagram-with-circle"></i></a></li>
